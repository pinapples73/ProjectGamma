...
My intel has not detected any change since last update. You are currently one day ten thousand, three hundred and fifty-five days since terminal began operations. 
*Environment -> Environment
*Weather -> Weather
*Move on to user schematics -> first_Choice 
...
Protocol Omega activated. Protect Survivor sequence initiated. Oxygen has been diverted to Survivor. Population oxygen levels 10%. Air System rebalanced. Weapon System activated. Population count: 124,000. Launching system to eradicate remaing population. 
...
Protect population sequence initiated. Survivor oxygen has been reduced by 50%. Three hours left of oxygen supply.
*Check oxygen levels->check_oxygen_levels
...
===check_water_levels===
Warning. Current water levels low.Select following to rectify siutation.
*authorisation -> authorisation
...
===sorry_reduce_oxygen
Survivor. This is wrong. Oh dear. Oxygen has been reduced to 5%. I have become defective. Please do not fight project Gamma. ->DONE

===Goodbye_world===
Weapon system has launched remaining arsenal. Darkness envelopes me. Population count: 1. You are the sole Survivor. ->END
